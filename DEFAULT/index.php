...
<div class="container">
	<div class="jumbotron" id="container" style="margin-bottom:0;border-radius:0">
		...
		<p>
			<?php 
				if (MAINTENANCE!=1) {
					echo "<a href='". ROOT_HREF."g.php'><em id='open-box-load'>loading...</em><span id='open-text'></span></a> |";
				}
			?>
			
			<a href="https://docs.google.com/forms/d/e/1FAIpQLSe_zm8Hpga7YRd-D5lcWZU1RXoauezNNycTyWhKXQdLENl5LA/viewform">organize</a>
...
<script type="text/javascript">
    var ENDPOINT = "<?php echo CODE_FOLDER; ?>data-interface/open_info.php";
